...
urlpatterns = [
    ...
    path('employees/all',crm_views.EmployeeList.as_view(),name='emp-list'),
    path('employees/<int:pk>/remove/',crm_views.EmployeeDeleteView.as_view(),name='emp-delete'),
    path('employees/<int:pk>',crm_views.EmploteeDetailView.as_view(),name='emp-detail'),
    path('employees/<int:pk>/edit',crm_views.EmployeeEditView.as_view(),name='emp-edit'),
    path('register/',crm_views.Signup.as_view(),name='register'),
